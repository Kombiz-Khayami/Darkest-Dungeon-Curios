    ...
    <div class="wrapper-main" >
        ...
        <div class="wrapper-row">
            <div class="wrapper-curio"> 
                ...
                <div class="curio-name">Forgotten Delicacies</div>
        ...
        <div class="wrapper-row">
            ...
            <div> 
                ...
                <div class="items-cleansing">
                    <img src={images.activators.bandages.path} /> 
                    <img src={images.activators.theBlood.path} class="blood-icon"/> Blood x1 16.7% (50%)
                    These bones hold riches!
                </div>  
                <div class="items-cleansing">
                    <img src={images.activators.theBlood.path} /> 
        ...
        <div class="wrapper-row">
            <div class="wrapper-curio"> 
                    Thronging Hive
                <img src="images/Thronging_Hive.png" />
            </div>
            <div class="wrapper-without-cleansing">
                        <div class="item-without-cleansing">
